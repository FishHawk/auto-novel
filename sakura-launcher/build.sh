...
declare -a arr=(
    ...
    "llama-$VERSION-bin-win-cuda-cu11.7.1-x64.zip"
    #
    "cudart-llama-bin-win-cu12.2.0-x64.zip"
    "llama-$VERSION-bin-win-cuda-cu12.2.0-x64.zip"
    #
...
pack "sakura-launcher-cuda11-$VERSION" 0 1
pack "sakura-launcher-cuda12-$VERSION" 2 3
